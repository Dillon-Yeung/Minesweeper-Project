...
covered = load_img('compare/cover.png', cv2.IMREAD_GRAYSCALE)
empty = load_img('compare/empty.png', cv2.IMREAD_GRAYSCALE)
one = load_img('compare/1.png', cv2.IMREAD_GRAYSCALE)
two = load_img('compare/2.png', cv2.IMREAD_GRAYSCALE)
three = load_img('compare/3.png', cv2.IMREAD_GRAYSCALE)
four = load_img('compare/4.png', cv2.IMREAD_GRAYSCALE)
five = load_img('compare/5.png', cv2.IMREAD_GRAYSCALE)
six = load_img('compare/6.png', cv2.IMREAD_GRAYSCALE)
seven = load_img('compare/7.png', cv2.IMREAD_GRAYSCALE)
eight = load_img('compare/8.png', cv2.IMREAD_GRAYSCALE)

class img_board():
    def __init__(self,bitmap,row,col):
        self.__rawimg = bitmap
        self.finalboard = self.test(row,col)
    ...
    def test(self,rows,cols):
        img = identify_cells(self.__rawimg,(covered,empty,one,two,three,four,five,six,seven,eight))
        ...
        results = self.__train_knn().findNearest(samples_array, k=1)[1].flatten()
...
image1 = img_board(test_case3,2,2)
boardtest1 = board(image1.finalboard)
boardtest1.visualise_board()
print("")
image2 = img_board(test_case1,16,16)
boardtest2 = board(image2.finalboard)
boardtest2.visualise_board()
